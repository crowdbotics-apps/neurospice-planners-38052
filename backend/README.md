...
## Project Structure
    ...
    ├── neurospice_planners_38052  # Django project configurations
...
1. Clone this repo and `cd neurospice_planners_38052`
...
2. Clone this repo and `cd neurospice_planners_38052`
